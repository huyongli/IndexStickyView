...
public class IndexStickyViewActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IndexHeaderFooterAdapter<UserEntity> favAdapter = new IndexHeaderFooterAdapter<UserEntity>("☆", "我的收藏", initFavDatas()) {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
                ...
                View view = LayoutInflater.from(IndexStickyViewActivity.this).inflate(R.layout.indexsticky_item_contact, parent, false);
        ...
        favAdapter.setOnItemClickListener(new OnItemClickListener<UserEntity>() {
            ...
            public void onItemClick(View childView, int position, UserEntity item) {
                Toast.makeText(IndexStickyViewActivity.this, "点击：" + item.getName() + ",位置：" + position, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        menuAdapter.setOnItemLongClickListener(new OnItemLongClickListener<MenuEntity>() {
            ...
            public  void onItemLongClick(View childView, int position, MenuEntity item) {
                Toast.makeText(IndexStickyViewActivity.this, "长按：" + item.getMenuTitle() + ",位置：" + position, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        IndexHeaderFooterAdapter<UserEntity> normalAdapter = new IndexHeaderFooterAdapter<UserEntity>(null, null, Arrays.asList(entitys)) {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
                ...
                View view = LayoutInflater.from(IndexStickyViewActivity.this).inflate(android.R.layout.simple_list_item_1, parent, false);
        ...
        normalAdapter.setOnItemClickListener(new OnItemClickListener<UserEntity>() {
            @Override
            public void onItemClick(View childView, int position, UserEntity item) {
                Toast.makeText(IndexStickyViewActivity.this, "普通Header视图点击：" + item.getName() + ",位置：" + position, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mIndexStickyView.addIndexHeaderAdapter(new IndexHeaderFooterAdapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
                ...
                View view = LayoutInflater.from(IndexStickyViewActivity.this).inflate(R.layout.indexsticky_header_contact_banner, parent, false);
                ImageViewVH vh = new ImageViewVH(view);
                vh.img.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(IndexStickyViewActivity.this, "头部普通图片视图点击", Toast.LENGTH_SHORT).show();
                    }
                });
                return vh;
            }
        ...
        footerAdapter.setOnItemClickListener(new OnItemClickListener<UserEntity>() {
            @Override
            public void onItemClick(View childView, int position, UserEntity item) {
                Toast.makeText(IndexStickyViewActivity.this, "点击Footer：" + item.getName() + ",位置：" + position, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    class MyIndexStickyViewAdapter extends IndexStickyViewAdapter<ContactEntity> {
        ...
        public RecyclerView.ViewHolder onCreateIndexViewHolder(ViewGroup parent) {
            ...
            View view = LayoutInflater.from(IndexStickyViewActivity.this).inflate(R.layout.indexsticky_item_contact_index, parent, false);
    ...
    public void onItemLongClick(View childView, int position, ContactEntity item) {
        ...
        Toast.makeText(IndexStickyViewActivity.this, "长按：" + item.getName() + ",位置：" + position, Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.toolbar_add:
                ...
                Toast.makeText(IndexStickyViewActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
